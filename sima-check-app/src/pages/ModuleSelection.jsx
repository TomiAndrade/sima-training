  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col">
      ...
      <div className="bg-slate-900 border-b border-slate-700 px-6 pt-8 pb-6">
        <button onClick={onBack} className="text-amber-500 text-lg font-semibold mb-5 flex items-center gap-2 touch-manipulation">
          ‹ Cambiar empleado
        </button>
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-full bg-amber-500/20 border-2 border-amber-500 flex items-center justify-center text-amber-500 font-black text-xl">
      ...
      <div className="flex-1 p-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
        {modules.map((mod) => (
          <button
            ...
            className="group text-left bg-slate-800 border-2 border-slate-700 hover:border-amber-500 active:bg-slate-700 rounded-2xl p-6 transition-all duration-150 touch-manipulation"
          >
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <span className="text-amber-500 text-xl font-bold group-hover:translate-x-1 transition-transform">›</span>
            </div>
          </button>
        ))}
      </div>
