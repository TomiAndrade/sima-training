...
// `backendTypeBadge` vivía acá y se movió a `core/format/tipoPregunta.jsx`:
// lo usaba también `core/components/ImportPreguntasModal.jsx`, y `core/` no
// puede importar de `sima-check/`. **Sin re-export puente a propósito** — un
// puente entre capas que sobrevive es el que después nadie se anima a borrar.
