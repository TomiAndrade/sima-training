...
export const api = {
  // Todo GET va con Bearer: las lecturas del backoffice dejaron de ser
  // públicas del lado del backend (quedan abiertas sólo tablet/invitado/
  // uploads/health, que no pasan por este cliente). Antes había un `get`
  // sin auth y un `getAuth` aparte para el único GET protegido
  // (`/sesiones/:id`) — se unificaron porque ahora todos lo están.
